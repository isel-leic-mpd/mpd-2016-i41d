...
public class Transactions{
    ...
    public static void main(String [] args){
        ...
        */
        ...
        init() // Stream<Transaction>
            .filter( trx ->   // Transaction -> boolean
                Arrays
                .stream(trx.traders)                     // Stream<Trader>
                .filter(t -> t.city.equals("Cambridge")) // Stream<Trader> só de Cambridge
                .findAny()                               // Trader qualquer que vive em Cambridge
                .isPresent())                            // boolean
            .mapToInt(trx -> trx.value)    // Transaction -> int
        ...
        init() // Stream<Transaction>
            .filter( trx ->   // Transaction -> boolean
                Arrays
                .stream(trx.traders)                       // Stream<Trader>
                .anyMatch(t -> t.city.equals("Cambridge"))) 
            .mapToInt(trx -> trx.value)    // Transaction -> int
            .forEach(v -> System.out.print(v + " "));
     }
}